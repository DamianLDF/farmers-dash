...
;-------------------------------------
; Prepare the sound engine to play a song or sfx.
;   input:
...
sound_load:
    ...
    tay
    lda sound_headers, y     ;setup the pointer to our song header
    sta sound_ptr
    lda sound_headers+1, y
    sta sound_ptr+1
    jmp se_load
song_load:
    sta current_song
...
MUSIC_GAME = $01
song_headers:
    .word mute_header  ;this is a silence song.
    .word song1_header
    .word song2_header
...
sound_headers:
    ...
    .include "sound_engine/sound_opcodes.asm"    ;our opcode subroutines, jump table and aliases
    .include "sound_engine/note_table.i" ;period lookup table for notes
    .include "sound_engine/note_length_table.i"
    .include "sound_engine/vol_envelopes.i"
    .include "sound_engine/mute.i"  ;holds the data for muting all channels (header and data streams)
    .include "music/song1.i"  ;holds the data for song 1
    .include "music/song2.i"  ;holds the data for song 1
    
    .include "sounds/sound1.i"
    .include "sounds/sound2.i"
    .include "sounds/sound3.i"
    .include "sounds/sound4.i"
    .include "sounds/sound5.i"
    .include "sounds/sound6.i"
    .include "sounds/sound7.i"
    .include "sounds/sound8.i"
    .include "sounds/sound9.i"
    .include "sounds/soundA.i"
